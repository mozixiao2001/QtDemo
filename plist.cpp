...
bool PList::read(QIODevice *device)
{
...
const QList<QVariant> PList::data() const
{
    return m_data;
}

QString PList::errorString() const
{
    return QString("%1\nLine %2, column %3")
...
void PList::readArray(QList<QVariant> &array)
{
...
void PList::readDict(QList<QVariant> &array)
{
...
void PList::readKey(QMap<QString, QVariant> &dict)
{
